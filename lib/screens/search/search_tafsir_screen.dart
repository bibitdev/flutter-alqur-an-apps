...
class SearchTafsirScreen extends StatefulWidget {
  const SearchTafsirScreen({super.key});

  @override
  State<SearchTafsirScreen> createState() => _SearchTafsirScreenState();
}

class _SearchTafsirScreenState extends State<SearchTafsirScreen> {
      ...
      return Center(
        child: Column(
          ...
          children: [
            ...
            Text(
              'Ketik nama surah untuk mencari tafsir...',
      ...
      GestureDetector(
        ...
        onTap: () {
          Navigator.of(context).push(MaterialPageRoute(
              builder: (context) => DetailTafsirScreen(noSurah: surah.nomor)));
        },
        child: Padding(
